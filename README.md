...
## Emission inventory
* [getDataCompress_zurich_2019.py](/emissionInventory/getDataCompress_zurich_2019.py) downloads the Automatic Dependent Surveillance–Broadcast data from [OpenSky Network](https://opensky-network.org/).
