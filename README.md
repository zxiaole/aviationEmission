...
* [createAirportMask.m](/emissionInventory/preprocessing/createAirportMask.m): the background image for the airport can be generated using QGIS, and it can be exported and saved as .jpgw format with coordinates. Then, the mask for the airport area can be generated based on the background image using this code.
